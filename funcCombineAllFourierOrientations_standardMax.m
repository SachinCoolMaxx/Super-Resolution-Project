function S2_HR = funcCombineAllFourierOrientations_standardMax(S2_r, all_axes, p, orig_size, md)
...
S2_HR = S2_HR(md(1)+1+x:md(1)+sz(1)+x, md(2)+1+y:md(2)+sz(2)+y, md(3)+1+z:md(3)+sz(3)+z);

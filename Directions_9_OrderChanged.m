    ...
    for witer = 1%:3
      ...
      %  for p = [0.05, 0.1, 0.2, 0.8, 1.2, 2,4,8,12]
       for p = [35]
            ...
            outfile = [results_dir,subjname, '_varPatchsize_ANR_truncSinc_FinalSuperRes_pMaximum(p=infi)',num2str(p),'_NExxxx3dpatches_withHROldnewrotation',num2str(window),'_9dirOrderChanged_.nii'];
